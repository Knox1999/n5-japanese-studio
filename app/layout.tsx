...
export const metadata: Metadata = {
  ...
  description:'A futuristic Japanese-learning studio with vocabulary classes, verb groups, natural Japanese audio, smart recall, listening, shadowing, reading, grammar, KLC Kanji and mastery practice.',
...
export const viewport:Viewport={width:'device-width',initialScale:1,viewportFit:'cover',themeColor:'#06172D'};
