...
export default function Listening({data}:{data:LessonPayload}){
  ...
  return <div className="space-y-5 pb-8 shadowing-view-v57 listening-v82 listening-v89">
    <section className="study-header tone-listen"><div><div className="section-kicker">JAPANESE LISTENING · LESSON {String(data.lesson).padStart(2,'0')}</div><h1>Hear → Understand → Shadow</h1><p className={language==='bn'?'font-bn':''}>{text('অর্থ লুকানো অবস্থায় প্রথমে natural Japanese শুনুন ও বুঝতে চেষ্টা করুন। তারপর অর্থ মিলিয়ে একই rhythm-এ তিনবার shadow করুন।','First listen to natural Japanese with the meaning hidden. Check your understanding, then shadow the same rhythm three times.')}</p></div><Headphones className="header-big-icon"/></section>
